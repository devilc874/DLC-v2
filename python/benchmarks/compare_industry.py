...
def run_benchmark():
    ...
    print()
    print("=" * 140)
    print("  DLC v2 vs INDUSTRY TIME-SERIES COMPRESSION TECHNIQUES")
    print("=" * 140)
    print()
    print("  Techniques compared:")
    print("    * Gorilla       -- Facebook (2015), XOR + leading/trailing zero encoding  [LOSSLESS]")
    print("    * Delta-of-Delta-- InfluxDB / Prometheus, 2nd-order diff + varint (12-bit) [NEAR-LOSSLESS]")
    ...
    print("=" * 80)
    print()
    print("  DoD uses 12-bit quantization --> max error ~1.2e-04 per sample")
